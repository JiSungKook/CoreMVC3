#pragma checksum "E:\www\WebMVCCore3\MyWeb\MyWeb.HomeWeb\Views\Shared\Components\LeftMenu\Default.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1582cf1733d1b35b0ef92c43dc32b93e93cefe87"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1582cf1733d1b35b0ef92c43dc32b93e93cefe87", @"/Views/Shared/Components/LeftMenu/Default.cshtml")]
    ...
    <nav class=""sidebar-nav"">
        <ul id=""sidebarnav"">
            ...
            <li class=""sidebar-item"">
                <a class=""sidebar-link"" href=""/Information/History"" aria-expanded=""false"">
            ...
            <li class=""sidebar-item"">
                <a class=""sidebar-link"" href=""/home/TicketList"" aria-expanded=""false"">
                    <i data-feathe");
            WriteLiteral(@"r=""tag"" class=""feather-icon""></i><span class=""hide-menu"">
                        Ticket List
                    </span>
                </a>
            </li>
            ...
            <li class=""sidebar-item"">
                <a class=""sidebar-link"" href=""/home/boardlist"" aria-expanded=""false"">
                    <i data-feather=""tag"" class=""feather-icon""></i><span class=""hide-menu"">
                        게시판
                    </span>
                </a>
            ...
            <li class=""sidebar-item"">
                <a class=""sidebar-link sidebar-link"" href=""app-calendar.html""
                   aria-expanded=""false"">
                    <i data-feather=""calendar"" class=""feather-icon""></i><span class=""");
            WriteLiteral(@"hide-menu"">Calendar</span>
                </a>
            </li>
            ...
            <li class=""sidebar-item"">
                ...
                <ul aria-expanded=""false"" class=""collapse  first-level base-level-line"">
                    <li class=""sidebar-item"">
                        <a href=""table-basic.");
            WriteLiteral(@"html"" class=""sidebar-link"">
                            <span class=""hide-menu"">
                                Basic Table
                            </span>
                        </a>
...
");
            ...
            <li class=""sidebar-item"">
                <a class=""sidebar-link has-arrow"" href=""javasc");
            ...
            WriteLiteral(@"/li>
                    ...
                    <li class=""sidebar-item"">
                        <a href=""ui-toasts.html"" class=""sidebar-link"">
                            <span class=""hide-menu""> Toa");
            WriteLiteral(@"sts</span>
                        </a>
                    </li>
                    <li class=""sidebar-item"">
            ...
            <li class=""sidebar-item"">
                <a class=""sidebar-link sidebar-link"" href=""/login/Login""
                   aria-expanded=""false"">
                    <i data-feather=""lock"" ");
            WriteLiteral(@"class=""feather-icon""></i><span class=""hide-menu"">
                        Login
                    </span>
                </a>
            </li>
            <li class=""sidebar-item"">
                <a class=""sidebar-link sidebar-link""
                   href=""/login/register"" aria-expanded=""false"">
                    <i data-feather=""lock""
            ...
            <li class=""sidebar-item"">
                ...
                <ul aria-expanded=""false"" class=""collapse first-level base-level-line"">
                    <li class=""sidebar-item"">
                        <a href=""icon-f");
            WriteLiteral(@"ontawesome.html"" class=""sidebar-link"">
            ...
            <li class=""sidebar-item"">
                ...
                <ul aria-expanded=""false"" class=""collapse first-level base-level-line"">
                    <li class=""sidebar-item"">
                       ");
            WriteLiteral(@" <a href=""javascript:void(0)"" class=""sidebar-link"">
            ...
            WriteLiteral(@"1.3.1
                            ...
                            <li class=""sidebar-item"">
                                <a href=""");
            WriteLiteral(@"javascript:void(0)"" class=""sidebar-link"">
                                    <span class=""hide-menu"">
                                        item
                                        1.3.4
                                    </span>
            ...
            <li class=""sidebar-item"">
                <a class=""sidebar-link sidebar-link"" href=""//docs/docs.html""
                   aria-expanded=""false"">
 ");
            WriteLiteral(@"                   <i data-feather=""edit-3"" class=""feather-icon""></i><span class=""hide-menu"">Documentation</span>
                </a>
            </li>
            <li class=""sidebar-item"">
                <a class=""sidebar-link sidebar-link"" href=""/login/LoginOut"" aria-expanded=""false"">
